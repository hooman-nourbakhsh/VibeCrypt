...
For Windows users, download the standalone `.exe` file from the [Releases](https://github.com/hooman-nourbakhsh/CoreLock/releases) section. No installation or dependencies are required—just run the executable to launch the GUI and secure your assets instantly! 🔐
